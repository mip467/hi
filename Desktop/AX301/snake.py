...
class Application:
    ...
    def spawn_food(self):
        ...
        position = (round(random.randint(20, width-20), -1), round(random.randint(20, width-20), -1))
    ...
    def game_over(self):
      ...
      self.canvas.create_text((width/2, height/2), text="Game Over! Your score is: %d" % score)
